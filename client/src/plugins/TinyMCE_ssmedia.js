...
(() => {
  const ssmedia = {
     ...
     */
    init(editor) {
      const insertTitle = i18n._t('TinyMCE.INSERT_FROM_FILES', 'Insert from Files');
      const editTitle = i18n._t('TinyMCE.EDIT_IMAGE', 'Edit image');
      const deleteTitle = i18n._t('TinyMCE.DELETE_IMAGE', 'Delete image');
      const contextTitle = i18n._t('TinyMCE.FILE', 'File');
